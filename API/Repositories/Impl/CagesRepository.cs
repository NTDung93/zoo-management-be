...
namespace API.Repositories.Impl
{
    public class CagesRepository : ICagesRepository
    {
        ...
        {
            return await _context.Cages.Include(x => x.Area).SingleOrDefaultAsync(cage => cage.CageId.ToLower().Equals(cageId.Trim().ToLower()));
        }
        ...
        public async Task UpdateCage(string cageId, CageDto cageDto)
        {
            ...
            currCage.Result.MaxCapacity = (int)cageDto.MaxCapacity;
